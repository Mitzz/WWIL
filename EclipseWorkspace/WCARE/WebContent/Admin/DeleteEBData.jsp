...
if(dynabean != null){
	...
	eb = dynabean.getProperty("EBIdtxt") == null ? "" : dynabean.getProperty("EBIdtxt").toString();
...
String sEb = AdminUtil.fillWhereMaster("SELECT_EB_MASTER",eb,site);
...
<form action="<%=request.getContextPath()%>/DeleteEBData.do" method="post" name="DeleteEBDatafrm">
<table align="center" border="0" cellpadding="0" cellspacing="0" width="500">
	<tbody><tr>
	<td class="newhead1"></td>
	<th class="headtext">Delete EB Reading</th>
...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td bgcolor="#dbeaf5">
		...
		<tr class="bgcolor"> 
			...
			<td class="bgcolor">
				<select size="1" id="EBIdtxt" name="EBIdtxt" class="ctrl" >
		            <option value="">--Make a Selection--</option>
		            <%=sEb %>
		        </select>
			</td>
		...
		<tr class="bgcolor"> 
			...
			<td class="bgcolor">
				...
				<a href="javascript:void(0)" id="dc" onClick="if(self.gfPop)gfPop.fPopCalendar(document.DeleteEBDatafrm.FromDatetxt);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=request.getContextPath()%>/resources/images/calbtn.gif" border="0" alt=""></a>
			</td>
		</tr>		
		<tr class="bgcolor"> 
			...
			<td class="bgcolor">
				...
				<a href="javascript:void(0)" id="dc1" onClick="if(self.gfPop)gfPop.fPopCalendar(document.DeleteEBDatafrm.ToDatetxt);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=request.getContextPath()%>/resources/images/calbtn.gif" border="0" alt=""></a>
			</td>
		</tr>							
		<tr class="bgcolor"> 
			<td colspan="2">
...
<tr>
	...
	<tbody><tr>
		...
		<td class="btn" width="100">
		<input type="hidden" name="Admin_Input_Type" value="DeleteEBData" />		
