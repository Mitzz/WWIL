...
if(dynabean != null){
	...
	wec = dynabean.getProperty("WECIdtxt") == null ? "" : dynabean.getProperty("WECIdtxt").toString();
...
String sSite = AdminUtil.fillWhereMaster("TBL_STATE_SITE_RIGHTS",site,userid);
String sWEC = AdminUtil.fillWhereMaster("FIND_WEC_BY_SITE",wec,site);
String mps = AdminUtil.fillWhereMaster("TBL_MP_MASTER",mp,"WEC");
%>
...
<form action="<%=request.getContextPath()%>/DeleteWECData.do" method="post" name="DeleteWECDatafrm">
<table align="center" border="0" cellpadding="0" cellspacing="0" width="500">
	<tbody><tr>
	<td class="newhead1"></td>
	<th class="headtext">Delete WEC Reading</th>
...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td bgcolor="#dbeaf5">
		...
		<tr class="bgcolor"> 
			<td id="t_street_address">&nbsp;Select&nbsp;WEC:</td>
			<td class="bgcolor">
				<select size="1" id="WECIdtxt" name="WECIdtxt" class="ctrl" >
		            <option value="">--Make a Selection--</option>
		            <%=sWEC %>
		        </select>
			</td>
		...
		<tr class="bgcolor"> 
			...
			<td class="bgcolor">
				<input type="text" name="FromDatetxt" id="FromDatetxt" size="20" class="ctrl" maxlength="10" value="<%=fd %>" onfocus="dc.focus()" />
				<a href="javascript:void(0)" id="dc" onClick="if(self.gfPop)gfPop.fPopCalendar(document.DeleteWECDatafrm.FromDatetxt);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=request.getContextPath()%>/resources/images/calbtn.gif" border="0" alt=""></a>
			</td>
		</tr>		
		<tr class="bgcolor"> 
			...
			<td class="bgcolor">
				...
				<a href="javascript:void(0)" id="dc1" onClick="if(self.gfPop)gfPop.fPopCalendar(document.DeleteWECDatafrm.ToDatetxt);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=request.getContextPath()%>/resources/images/calbtn.gif" border="0" alt=""></a>
			</td>
		</tr>					
		<tr class="bgcolor"> 
			<td colspan="2">
...
<tr>
	...
	<tbody><tr>
		...
		<td class="btn" width="100">
		<input type="hidden" name="Admin_Input_Type" value="DeleteWECData" />		
