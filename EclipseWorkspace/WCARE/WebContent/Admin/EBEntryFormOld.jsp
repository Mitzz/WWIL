...
String strt = request.getParameter("strt").toString();
String endd = request.getParameter("endd").toString();
////System.out.println(strt);
////System.out.println(endd);
%>
<title>EB Reading ~~~ Date : <%=request.getParameter("date").toString() %></title>
...
function fillTransaction() 
{
	 ...
	 req.open("POST", "<%=request.getContextPath()%>/Ajax.do", true);
	 req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	 req.send("Admin_Input_Type=get&AppId="+LocId);
}
...
{
	 var req = newXMLHttpRequest();
     var ApplicationId = document.getElementById("SiteIdtxt").value + "," + document.getElementById("Datetxt").value + "," + document.getElementById("Typetxt").value + "," + document.getElementById("Starttxt").value + "," + document.getElementById("Endtxt").value;
...
{
	 var req = newXMLHttpRequest();
     var ApplicationId = document.getElementById("SiteIdtxt").value + "," + pdate + ",.," + document.getElementById("Starttxt").value + "," + document.getElementById("Endtxt").value;
