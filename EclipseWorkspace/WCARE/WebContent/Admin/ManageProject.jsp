...
var colsOption = [
     {id: 'no' , header: "Projectid" , width :120, editor:{type:"text",validRule:['R','N']}},
     {id: 'employee' , header: "Customer" , width :140, editor:{type:"text",validRule:['R','ENC']}},
	   {id: 'country' , header: "Name" , width :130, editor:{type:"text",validRule:['R']}},
	   {id: 'customer' , header: "Site" , width :140, editor:{type:"text",validRule:['R','E']}  },
	   {id: 'quality' , header: "Quantity" , width :120, editor:{type:"text",validRule:['R','N']}},
        {id: 'bill2005' , header: "Type" , width :60 , editor:{type:"text",validRule:['R','N']}},
	   {id: 'bill2006' , header: "Capacity" , width :60, editor:{type:"text",validRule:['R','N']}}
...
tranList = (List)secutils.getprojects();  
%>
...
["<%=(String)v.get(0)%>","<%=(String)v.get(1)%>", "<%=(String)v.get(2)%>", "<%=(String)v.get(3)%>", "<%=(String)v.get(5)%>","<%=(String)v.get(6)%>","<%=(String)v.get(7)%>"]				
<%
...
<body>
<div align="center">
<FORM  ENCTYPE="multipart/form-data" ACTION="upload_csv.jsp?UploadType=ProjectMaster" METHOD=POST>

<table align="center" border="0" cellpadding="0" cellspacing="0" width="614">
<tbody><tr>
	<td class="newhead1" width="10"></td>
	<th class="headtext" width="70">Project Master</th>
