...
var colsOption = [
     {id: 'no' , header: "ACTIVITYTRANID" , width :120, editor:{type:"text",validRule:['R','N']}},
     {id: 'employee' , header: "ACTIVITYNO" , width :140, editor:{type:"text",validRule:['R','ENC']}},
	  {id: 'country' , header: "ACTIVITYDESC" , width :130, editor:{type:"text",validRule:['R']}},
	 {id: 'customer' , header: "PLAN_STARTDATE" , width :140, editor:{type:"text",validRule:['R','E']}},
	  {id: 'quality' , header: "PLAN_ENDDATE" , width :120, editor:{type:"text",validRule:['R','N']}},
       {id: 'bill2005' , header: "ACTUAL_STARTDATE" , width :60 , inChart :true, chartColor : 'eecc99'},
	   {id: 'bill2006' , header: "ACTUAL_ENDDATE" , width :60, inChart :true, chartColor : '99bb88'}
...
tranList = (List)secutils.getprojectsactivitytransaction();  
...
["<%=(String)v.get(0)%>","<%=(String)v.get(1)%>", "<%=(String)v.get(2)%>", "<%=(String)v.get(3)%>", "<%=(String)v.get(4)%>","<%=(String)v.get(5)%>","<%=(String)v.get(6)%>"]				
<%
...
<body>
	...
	<tr bgcolor="#94A664" height=5 class="textheadline2">
		<td align="center">Activity Transaction</td>
	</tr>
