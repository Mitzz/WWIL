...
<form action="<%=request.getContextPath()%>/PublishData.do" method="post" name="PublishData" onSubmit="return findvalidate()">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td bgcolor="#dbeaf5">
		...
		<tr class="bgcolor"> 
			...
			<td class="bgcolor">
				...
				<a href="javascript:void(0)" id="dc" onClick="if(self.gfPop)gfPop.fPopCalendar(document.PublishData.Datetxt);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=request.getContextPath()%>/resources/images/calbtn.gif" border="0" alt=""></a>
			</td>
		</tr>
		<tr class="bgcolor"> 
...
<tr>
	...
	<tbody><tr>
		<td class="btn" width="100">
			...
			<input type="hidden" name="Admin_Input_Type" value="PublishData" />
		</td>
