	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td bgcolor="#dbeaf5">
		...
		<tr class="bgcolor"> 
			<td class="bgcolor" colspan="2" align="center">
				<a href="<%=request.getContextPath()%>/Admin/ExcelFiles/WecData.htm" target="_blank"><span class="linkbluebold">Excel File Sample</span></a>
			</td>
		</tr>	
		<tr class="bgcolor"> 
			<td colspan="2">
...
<tr>
	...
	<tbody><tr>
		<td class="btn" width="100">
			<input type="hidden" name="Admin_Input_Type" value="UploadWECData" />
