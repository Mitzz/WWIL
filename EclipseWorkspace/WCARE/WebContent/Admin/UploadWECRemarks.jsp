...
java.util.Date ldate = format.parse("30/04/2010");
%>
</head>
<body>
<%if (ldate.after(cdate)){ %>
<script type="text/javascript">
	alert("Upload Excel format has been changed w.e.f. 05-April-2010! \n Kindly check Excel file sample and Change excel file according. \n Also refresh Excel Format once it gets loaded");
</script>
<%} %>
<div align="center">
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="500">
	...
	<th class="headtext">Upload WEC Remarks</th>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td bgcolor="#dbeaf5">
		...
		<tr class="bgcolor"> 
			<td class="bgcolor" colspan="2" align="center">
				<a href="<%=request.getContextPath()%>/Admin/ExcelFiles/WecRemarks.htm" target="_blank"><span class="linkbluebold">Excel File Sample</span></a>
			</td>
		</tr>	
		<tr class="bgcolor"> 
			<td colspan="2">
...
<tr>
	...
	<tbody><tr>
		<td class="btn" width="100">
			<input type="hidden" name="Admin_Input_Type" value="UploadWECRemarks" />
