...
function showData(dataXml,a,b)
{
	...
	console.log("Value of HTML content in ajax handler of findData():");
   	...
   	{	  	
     	...
     	if (nname != null){
     		if (item.getElementsByTagName("wecstatus")[0].firstChild.nodeValue == 1)
     		{
			    ...
			    str += "<input type='hidden' name='"+wecidd+"' id='"+wecidd+"'  value='"+item.getElementsByTagName("mfact")[0].firstChild.nodeValue+"' />"
...
<%
//String inputType = "";
//if (session.getAttribute("RoleID") == "0000000001")
//{
//	inputType = "WECEntry";	
//}
//else {
//	inputType = "WECEntry_user";
//}
%>
</head>
