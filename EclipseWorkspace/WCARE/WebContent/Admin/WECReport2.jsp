   		...
   		<table width="550" cellspacing="0" cellpadding="0">
   			<tr>
   				<td>
					...
					<% String  fdate=(String)request.getParameter("stid"); 
	                String  ldate=(String)request.getParameter("siteid"); 
		...
		<form action="<%=request.getContextPath()%>/loginuser.do" method="post" name="frmLoginUser">
			<table width="550" cellspacing="0" cellpadding="0">
				<tr class="tabtextnormal" align="left">
					<td width="100" height="30" align="left">Select State</td>
					<td width="8">:</td>
					<td width="400">
					</td>
				</tr>
				<tr class="tabtextnormal" align="left">
					<td width="100" height="30" align="left">Select Site</td>
					<td width="8">:</td>
					<td width="400">
					</td>
				</tr>
				<tr class="tabtextnormal" align="left">
					<td width="100" height="30" align="left">Select EB</td>
					<td width="8">:</td>
					<td width="400">
					</td>
				</tr>
				<tr class="tabtextnormal" align="left">
					<td width="100" height="30" align="left">Select Customer</td>
					<td width="8">:</td>
					<td width="400">
					</td>
				</tr>					
