...
function loadExternal(url) {
	...
	var state=list4.options[list4.selectedIndex].value;
	var wec=list3.options[list3.selectedIndex].value;
	
	
    var rd;	
   
    url="AdminCompareView.jsp";
    if(type=="M" || type=="DM" )
     {
   	...
   	if(url !=""){
	 	if (window.frames['ifrm'] ) {
				...
				var list2=document.forms[0].CustIdtxt;
	   					  ...
	   					  window.frames['ifrm'].location = url+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type+"&Compare="+comparetxt+"&state="+state+"&wec="+wec;
...
function checkWholeForm() {
    var why = "";
         if(document.forms[0].CustIdtxt.selectedIndex==0 && document.forms[0].StateIdtxt.selectedIndex==0)
           {
...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td bgcolor="#dbeaf5">
		...
		<tr class="bgcolor"> 
		  ...
		  <tr class="bgcolor" >
											<td id="t_street_address" colspan="3" align="center">OR</td>
										</tr>
