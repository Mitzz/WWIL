...
function loadExternal(url) {
    ...
    if(type=="M" || type=="DM" )
     ...
     rd=document.forms[0].Datetxt.value;	
	  ...
	  url = url+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type;
...
function checkWholeForm() {
    var why = "";    
     	why += checkDropdown(document.forms[0].CustIdtxt.options[document.forms[0].CustIdtxt.selectedIndex].value);
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="500">
	...
	<th class="headtext">Analysis Report</th>
