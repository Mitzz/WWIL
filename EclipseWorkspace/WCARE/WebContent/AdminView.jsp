        ...
        for (int i=0; i <tranList.size(); i++)
			{
		        ...
		        for (int j=0; j <sitetranList.size(); j++)
					...
					if(type.equals("D"))
						strXML +="<tr align='left' class=TableRow2><td class=TableCell><a href=CustomerAdminReport.jsp?stateid="+stateid+"&siteid="+siteid+"&id="+custid+"&type="+type+"&rd="+rdate+">"+sname+"</td><td class=TableCellRight>"+v1.get(18)+"</td><td class=TableCellRight>"+v1.get(1)+"</td><td class=TableCellRight>"+v1.get(19)+"</td><td class=TableCellRight>"+v1.get(2)+"</td><td class=TableCellRight>"+v1.get(3)+"</td><td class=TableCellRight>"+v1.get(4)+"</td><td class=TableCellRight>"+v1.get(5)+"</td><td class=TableCellRight>"+v1.get(6)+"</td>   <td class=TableCellRight>"+v1.get(7)+"</td><td class=TableCellRight>"+v1.get(8)+"</td><td class=TableCellRight>"+v1.get(9)+"</td><td class=TableCellRight>"+v1.get(12)+"</td>  <td class=TableCellRight>"+v1.get(10)+"</td><td class=TableCellRight>"+v1.get(14)+"</td><td class=TableCellRight>"+v1.get(11)+"</td> <td class=TableCellRight>"+v1.get(15)+"</td><td class=TableCellRight>"+v1.get(16)+"</td><td class=TableCellRight>"+v1.get(17)+"</td> </tr>";
					else
						strXML +="<tr align='left' class=TableRow2><td class=TableCell><a href=CustomerAdminReport.jsp?stateid="+stateid+"&siteid="+siteid+"&id="+custid+"&type="+type+"&rd="+rdate+">"+sname+"</td><td class=TableCellRight>"+v1.get(1)+"</td><td class=TableCellRight>"+v1.get(2)+"</td><td class=TableCellRight>"+v1.get(3)+"</td><td class=TableCellRight>"+v1.get(4)+"</td><td class=TableCellRight>"+v1.get(5)+"</td><td class=TableCellRight>"+v1.get(6)+"</td><td class=TableCellRight>"+v1.get(7)+"</td><td class=TableCellRight>"+v1.get(8)+"</td><td class=TableCellRight>"+v1.get(9)+"</td><td class=TableCellRight>"+v1.get(12)+"</td>  <td class=TableCellRight>"+v1.get(10)+"</td><td class=TableCellRight>"+v1.get(14)+"</td><td class=TableCell>"+v1.get(11)+"</td> <td class=TableCellRight>"+v1.get(15)+"</td><td class=TableCellRight>"+v1.get(16)+"</td><td class=TableCellRight>"+v1.get(17)+"</td> </tr>";
