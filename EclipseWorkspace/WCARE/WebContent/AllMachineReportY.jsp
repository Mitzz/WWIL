...
<%
	...
	System.out.println("ffd.getYear(): " + ffd.getYear());
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	...
	<tr>
	<tr>
		<td class=SectionTitle1 align="left"><input type="button" value="Back" onClick=location.href="CustomerReport.jsp?stateid=<%=stateid%>&siteid=<%=siteid%>&id=<%=custid%>&type=<%=type%>&rd=<%=rdate%>"  class="printbutton">

		</td>
		<td class=SectionTitle1 colspan="2" align="right"> <input type="button" value="Print" onClick="window.print()" class="printbutton"><input type="button" value="Excel"  class="printbutton" onClick=location.href="ExportAllMachineY.jsp?custid=<%=custid%>&rd=<%=rdate%>&siteid=<%=siteid%>&stateid=<%=stateid%>">
	   </td>
	</tr>
	<TR>
			...
			<TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
				<TBODY>
					...
					<%
							...
							wecListData = (List) secutils.getWECMonthwise(ebid,
									wecid, rdate, type);
					...
					<%
								wecListData.clear();
								wecListData = (List) secutils.getWECDetailTotal(
								ebid, wecid, rdate, "Y");
