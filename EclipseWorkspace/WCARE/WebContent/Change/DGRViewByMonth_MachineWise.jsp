...
// String st="_blank";
    ...
    tranList_1 = CustomerUtility.getStateWiseTotalForOneMonthBasedOnCustomerId(custid, monthReceived, yearReceived);
    for (int i = 0; i < tranList_1.size(); i++) {
        ...
        sitetranList_3 = CustomerUtility.getSiteTotalForOneMonthBasedOnStateIdCustomerId(custid, stateid, monthReceived, yearReceived);
                ...
                if (diff < 0) {
                    if (true) {
                        strXML += "<tr class=" + cls + " align=left>"
                                + "<td class=TableCell1>"
                                + "<a href=CustomerReportByMonth_MachineWise.jsp?stateid=" + stateid + "&siteid=" + siteid + "&id=" + custid + "&type=" + type + "&rd=" + rdate + "&month=" + monthReceived + "&year=" + yearReceived + "  target='_blank'>" + sname + "</a>"
                                + "</td>"
