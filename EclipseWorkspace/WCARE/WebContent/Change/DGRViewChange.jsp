...
for (int i = 0; i < tranList_1.size(); i++) {
	...
	/*Data Not Available*/
	if(vector_12.size() == 4){
		strXML += "<tr class=TableSummaryRow><td class=TableCell1>" + vector_12.get(2) + "</td><td style='text-align:center;' colspan = '6'>Site Data Not Available</td></tr>";
		continue;
	}
	...
	if (custid.equals("1000000762")) {
		if (diff < 0) {
			strXML += "<tr class=TableSummaryRow align=center><td class=TableCell111 align=center><a href=javascript:onClick=popUp('"
					...
					+ NumberUtility.formatNumber((Long)vector_56.get(6))
					+ "</td><td class=TableCell111  align=center>"
					+ TimeUtility.convertMinutesToTimeStringFormat(((Long)vector_56.get(8)), ":") 
					+ "</td><td class=TableCell111  align=center>"
					+ TimeUtility.convertMinutesToTimeStringFormat(((Long)vector_56.get(12)), ":") 
					+ "</td><td class=TableCell111 align=center>"
					+ vector_56.get(15)
					+ "</td><td class=TableCell111 align=center>"
					+ vector_56.get(13)
					+ "</td><td class=TableCell111 align=center>"
					+ vector_56.get(14) + "</td></tr>";
		} else {
			strXML += "<tr class=TableSummaryRow align=center><td class=TableCell111 align=center><a href=javascript:onClick=popUp('"
					+ custid
					+ "','"
