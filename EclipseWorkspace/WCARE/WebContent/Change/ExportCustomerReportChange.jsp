                ...
                <TBODY>
                    <tr>
                        <TD align="right" colspan="6">
                            ...
                            <input align="right" type="button" class="printbutton" value="Excel" onClick=location.href="ExportCustomerReportChange.jsp?stateid=<%=stateid%>&siteid=<%=siteid %>&id=<%=custid%>&type=<%=type%>&rd=<%=rdate%>">
