...
<HTML>
    ...
    ArrayList<ArrayList<String>> customerMetaInfo = CustomerMetaInfo.getCustomerMetaInfoBasedOnWECTypeStateIdWithLoadCapacity(wec[0], stateID);
    if(debug){
    	GlobalUtils.displayVectorMember(customerMetaInfo);
    }
    %>
    ...
    for(int i = 0 ; i < customerMetaInfo.size(); i++){
    	...
    	/**/
    	ArrayList<ArrayList<Object>> wecWiseTotal = CustomerUtility.getOneSiteWECWiseTotalForBetweenDaysBasedOnSiteIdCustomerIdMeta(siteId, customerId, fromDate, toDate);
    	if(debug){
        ...
        <td vAlign ="middle"  align = "center" colspan="7"><b><%=customerName%></b></td><!-- Customer Name -->
        <td vAlign ="middle"  align = "center" colspan="4"><b>Capacity:<%=loadCapacity%></b></td><!-- Customer Name -->
    </TR>
    <%
    	int wecCount = 0;
    	...
    	if(wecCount > 1){
    		List<Object> siteTotal = CustomerUtility.getOneSiteTotalForBetweenDaysBasedOnSiteIdCustomerIdMeta(siteId, customerId, fromDate, toDate);
    		%>
    		<tr>
