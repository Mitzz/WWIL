...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
   ...
   <input  type="button"   value="Excel" onClick=location.href="ExportAdminReportM.jsp?wectype=<%=wectype%>&wecname=<%=wecname%>&ebid=<%=ebid%>&wecid=<%=wecid%>&rd=<%=rdate%>&state=<%=state%>&cname=<%=cname%>&type=M">
 
 </TD>
     </tr>
  <TR>
    
    <TD class=SectionTitle1 align="center" >Analysis Report  </TD>
    </TR></TBODY></TABLE>
