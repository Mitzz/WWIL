...
function checkDropdown(choice,txt) {
    var error = "";
    if (choice == 0) {
       error = "You didn't choose an option from the drop-down list "+txt+".\n";
    }    
return error;
}  
...
{   var why = ""; 
   ...
   var SiteTransactions = "";
    var custTransactions = "";
  		 ...
  		 why += checkDropdown(document.forms[0].Monthtxt.selectedIndex,"Month");
     	 why += checkDropdown(document.forms[0].Yeartxt.selectedIndex,"Year");
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="700">
	<tr width="100%">
		...
		<form name="CustomizeReportEB" id="CustomizeReportEB" action="<%=request.getContextPath()%>/ExportCustomizeBilling.jsp"  method="post" onSubmit="return checkWholeForm()" >
