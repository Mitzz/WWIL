...
<TABLE  width="100%" border="2">
	<TBODY>
		<TR>
			<TD  colspan="9" align="center" ><b>Generation Report</b></TD>
		</TR>
</TBODY></TABLE>
<TABLE width="90%" border="1">
	<TBODY>
		...
		<tr>
			...
			<td vAlign="middle"  align="left" width="24%" colspan="2"><b><%=v.get(8)%> X <%=v.get(6)%></b></td>
			</tr>
		<tr >
		...
		<tr>
			...
			<td vAlign="middle"  align="left" width="24%" colspan="2"><b><%=FromDatetxt%></b></td>
				...
				<TBODY>
					...
					%>
                       ...
                       <TR>
						<TD width="14.28%"></TD>
						<% if(diff<0){ %>
						<TD width="28.56%" colspan="6">Daily</TD>
						<%}else{ %>
						<TD width="28.56%" colspan="7">Daily</TD>
						<%} %>
					...
					<TR>
						...
						<TD width="7.28%"><b>Generation</b></TD>
						<TD width="5.28%"><b>Operating Hours</b></TD>
						
						<TD width="5.28%"><b>Lull Hours</b></TD>
						<TD width="5.28%"><b>Capacity Factor(%)</b></TD>
						<TD width="5.28%"><b>Machine Availability(%)</b></TD>
						<% if(diff<0){ %>
						 <TD width="14.28%"><b>Grid Availability(%)</b></TD>
						 <%} else{ %>
						 <TD width="5.14%"><b>Grid IAvailability(%) nternal </b></TD>
						 <TD  width="5.14%"><b>Grid Availability(%) External</b></TD>
					 <%} %>
