	...
	<TBODY>
		<tr>
			<TD align="left" colspan="2">
				<input  type="button" value="Back" onClick=location.href="DGRView.jsp?id=<%=custid%>&rd=<%=rdate%>&type=<%=atype%>"class="printbutton">
			</TD>
		    <td align="right" colspan="6">Export To:
		    	<input  align="right" type="button" value="Html" onClick=location.href="ExportNewDGRHtml.jsp?stateid=<%=stateid%>&siteid=<%=siteid %>&id=<%=custid%>&type=<%=type%>&rd=<%=rdate%>" class="printbutton">
				<input  align="right" type="button" value="Excel" onClick=location.href="ExportNewDGR.jsp?stateid=<%=stateid%>&siteid=<%=siteid %>&id=<%=custid%>&type=<%=type%>&rd=<%=rdate%>" class="printbutton">
		  		<input  align="right" type="button" value="PDF" onClick=location.href="pdffile.jsp?stateid=<%=stateid%>&siteid=<%=siteid %>&id=<%=custid%>&type=<%=type%>&rd=<%=rdate%>" class="printbutton">
