...
%> <%
 	...
 	tranList = (List) secutils.getEBHeadingTotal(custid, rdate);
...
<TABLE cellSpacing="1" cellPadding="1" width="100%" border="3">
	...
	<tr>
		<td vAlign="middle" align="center" width="" 100%"" colspan="8">
		<TABLE cellSpacing="1" cellPadding="1" width="100%" border="1">
			<TBODY>
				...
				<tr>
					...
					<td vAlign="middle" align="left" width="24%" colspan="3"><%=v.get(8)%> X <%=v.get(6)%></td>
				...
				<tr>
					...
					<td vAlign="middle" align="left" width="24%" colspan="3"><%=FromDatetxt%></td>
					<%
					...
					<td vAlign="middle" align="left" width="24%" colspan="3"><%=pdate%>-<%=ndate%></td>
                ...
                <tr>
					<td vAlign="middle" width="100%" align="center" colspan="8"><B>WEC DATA</B></td>
				</tr>
			</TBODY>
		</TABLE>
		...
		<TABLE cellSpacing="1" cellPadding="1" width="90%" border="1">
			<TBODY>
				...
				<TR>
					...
					<% if(diff<0){ %>
						<TD  width="14.28%" colspan="2"><b>Grid Availability(%)</b></TD>
						<%} else{ %>
		...
		<TABLE cellSpacing="1" cellPadding="1" width="100%" border="1">
			<TBODY>
				<TR>
					<TD width="32.5%" colspan="5"><b>Description</b></TD>
				...
				<TR>
					<TD width="32.5%" colspan="5"><%=vdata.get(0)%></TD>
