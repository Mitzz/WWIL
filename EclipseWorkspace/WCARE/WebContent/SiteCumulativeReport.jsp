...
<TABLE cellSpacing=0 class=SectionTitle1 cellPadding=0 width="100%" border=0>
	<TBODY>
		...
		<tr>
			...
			if (type.equals("M")) {
			%>
			<td colspan="2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="View All Machine" class="printbutton" onClick=location.href="AllMachineReportM.jsp?custid=<%=custid%>&rd=<%=rdate%>&siteid=<%=siteid%>&stateid=<%=stateid%>"></TD>
			...
			<td align="right" colspan="2"><input type="button" value="Print" onClick="window.print()" class="printbutton"><input align="right" type="button" class="printbutton" value="Excel" onClick=location.href="ExportSiteCumulativeReport.jsp?stateid=<%=stateid%>&siteid=<%=siteid %>&id=<%=custid%>&type=<%=Atype%>&rd=<%=rdate%>"></td>
		</TR>
		<TR>
			<td colspan="6"></td>
		</tr>
...
<TABLE cellSpacing=0 cellPadding=0 width="90%" border=0>
	<TBODY>
		...
		<tr class=TableSummaryRow>
			...
			<td vAlign=middle align=left width=38% colspan=2><%=v.get(2)%> - <%=v.get(3)%></td>
				...
				<TBODY>
					...
					<TR class=TableSummaryRow>
						...
						<%} else{%>
						   ...
						   <%}else {%>
						    <TD class=TableCell colspan=5></TD>
						<%}} %>
					</TR>
