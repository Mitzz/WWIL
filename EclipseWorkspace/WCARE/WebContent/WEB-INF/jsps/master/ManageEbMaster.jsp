...
<body>
	<div align="center">
		...
		<sf:form method="post" action="${pageContext.request.contextPath}/spring/ebMaster" modelAttribute="eb" id="EbMasterForm" name="EbMasterForm">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3" width="592"><img
											...
											<table border="0" cellpadding="2" cellspacing="1" width="592">
												<tbody>
													...
													<tr bgcolor="#ffffff">
														...
														<td valign="top">															
															<sf:input cssClass="ctrl" path="description" size="55" id="description" type="text" />
														</td>
													</tr>
													<tr bgcolor="#ffffff">
														...
														<input type="checkbox" value="2" class="ctrl" id="workingStatus" name="workingStatus"/>
														</td>
													</tr>
							...
							</table> <img src="<%=request.getContextPath()%>/resources/images/pixel.gif" border="0" height="10" width="1"><br></td>
