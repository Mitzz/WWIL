    ...
    <body>
        <div align="center">
           <%--  <html:form action="manageSiteRemarks" method="post" styleId="ManageSiteRemarksForm"> --%>
            <sf:form method="post" action="${pageContext.request.contextPath}/spring/siteRemark" modelAttribute="site" id="ManageSiteRemarksForm" name="ManageSiteRemarksForm">
                                                    ...
                                                    <tbody>
														...
														<tr class="bgcolor">
															...
															<td colspan="3" valign="top">									            	
												            	 <sf:input cssClass="ctrl" path="remark" size="100" id="remark" type="text" />
