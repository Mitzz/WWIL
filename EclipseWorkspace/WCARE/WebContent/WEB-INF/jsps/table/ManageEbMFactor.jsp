...
<html>
    <head>
        ...
        $(document).ready(function(){
    		...
    		$('#stateSelection').change(function(){
    			...
    			ebMFactorDetails.innerHTML = "";    			
    			$.fn.emptySelection(["#siteSelection", "#ebSelection"]);
			    ...
			    function displayEbs(ebMFs){
			    	...
			    	$.each(ebMFs, function (i, vo) {
	           			...
	           			if (i % 2 == 0) classPicker = "detailsbody";
		     				...
		     				str+="onClick=editEbMf(this) /></td></tr>";
	           		}); 
			    	ebMFactorDetails.innerHTML = str;
			     }			 			  
   			});
    		...
    		$(form).submit(function(){
    			$.fn.enableSelection(["#ebSelection"]);
    			if(!validateForm()){
    				return false;
    			}
    			if(!getConfirmation()){
    ...
    <body>
        <div align="center">
           <%--  <html:form action="manageEbMFactor" method="post" styleId="EbMFactorForm"> --%>
             <sf:form method="post" action="${pageContext.request.contextPath}/spring/ebMFactor" modelAttribute="ebMFactor" id="EbMFactorForm" name="EbMFactorForm">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="604">
                    <tbody><tr>
                            <td class="newhead1" width="10"></td>
                            <th class="headtext" width="110"> EB Multiplication Factor Master</th>
                                            ...
                                            <td bgcolor="#dbeaf5">
                                                <table border="0" cellpadding="2" cellspacing="1" width="592">
                                                    <tbody>
                                                        ...
                                                        <tr bgcolor="#ffffff">
                                                            <td id="t_company" width="219">Select EB:</td>
                                                            <td valign="top">                                                                
                                                        ...
                                                        <tr bgcolor="#ffffff">
                                                            ...
                                                            <td class="bgcolor">
																...
																<a href="javascript:void(0)" id="dc" onClick="if(self.gfPop)gfPop.fPopCalendar(document.EbMFactorForm.fromDate);return false;" >
                                                        ...
                                                        <tr bgcolor="#ffffff">
                                                            ...
                                                            <td class="bgcolor">
																...
																<a href="javascript:void(0)" id="dc" onClick="if(self.gfPop)gfPop.fPopCalendar(document.EbMFactorForm.toDate);return false;" >
																	<img class="PopcalTrigger" align="absmiddle" src="<%=request.getContextPath()%>/resources/images/calbtn.gif" border="0" alt="">
																</a>
															</td>			
                                                        </tr>	
