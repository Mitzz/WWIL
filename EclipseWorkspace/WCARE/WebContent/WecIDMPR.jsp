...
if(file==null || file.equals("")) file="WecIDMPR.xls";
...
<%
	...
	statetranList = (List)secutils.getState(wecid,ebid);  
	String sname; //,stateid
...
<%
		...
		tranList = (List)secutils.getMPRHeading1(wecid,ebid);  
		...
		<TR >
			...
			for (int j=0; j <tranList.size(); j++){ 
               ...
               <TR bgcolor="#CCCCCC">
		        ...
		        <%   
					int tra=0; 
		        	sitetranList = (List)secutils.getMPRSerachByWec(stid,cid,fdate,tdate,wectype,wecid,ebid);  
...
request.setCharacterEncoding("utf-8");
String file = request.getParameter("File"); 
if(file==null || file.equals("")) file="ExportExcel.xls";
response.addHeader("Content-Disposition","attachment; filename=\""+file+"\"");%>
