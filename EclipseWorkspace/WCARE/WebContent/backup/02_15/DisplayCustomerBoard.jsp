        ...
        <script type="text/javascript">
         ...
         $(document).ready(function() {             
        	   ...
        	   $("#button").hide();
	                  ...
	                  var xmlData = "  <contact-hierarchy>	<contact>		<office-location>			<office>Maharashtra</office> 			<office>Madhya Pradesh</office> 		</office-location>		<name> Prashant Yevale</name>		<designation> Dy. Manager </designation>		<email-id> prashant.yevale@windworldindia.com </email-id>		<contact-number> 9820943142 - 7417</contact-number>	</contact>		<contact>		<office-location>		    <office> Tamil Nadu</office> 		</office-location>		<name> Kaushik Guha </name>		<designation> Sr. Manager </designation>		<email-id> kaushik.guha@windworldindia.com</email-id>		<contact-number> 9930065602 - 7416</contact-number>	</contact>		<contact>		<office-location> 		    <office>Gujarat</office> 		    <office>Rajasthan</office> 		    <office>Delhi</office> 		    <office>&amp; Other Northern Parts</office> 		</office-location>		<name> Manvendra Singh </name>		<designation> Asst. Manager </designation>		<email-id> manvendra.singh@windworldindia.com </email-id>		<contact-number> 9167309988 - 7418</contact-number>	</contact>		<contact>		<office-location> 		    <office>Andhra Pradesh</office> <office>Karnataka</office>		   </office-location><name> Ritu Thakur</name><designation>Asst. Manager</designation><email-id> ritu.thakur@windworldindia.com </email-id><contact-number> 7506342191 - 7387</contact-number></contact></contact-hierarchy>";
	    	      ...
	    	      /*  $("#dynamictable1").html("Incase you are not able to reach the KAM, Please feel free to get in touch with the following officials").css({"background-color": "#D2EBAB",
		           ...
		           $('#dynamictable1').append('<table class="x" id="tb"></table>').css({"width":"90%"});
		           $("<tr/>", {id:"tr2"}).appendTo("#tb").css({"font-size": "12pt" , "text-align" : "center","font-weight" : "bold","font-family":"Times New Roman" ,"color":"#000","background":"#D2EBAB"});
		 	       $("<th/>", {text:"In case you are not able to reach the KAMs, please feel free to get in touch with the following officials",colspan:"5"}).appendTo("#tr2");
	    	       ...
	    	       $('#dynamictable2').append('<table class="x"></table>').css({"width":"90%"});;
