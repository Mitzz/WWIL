	...
	<tr>
		<td>
			<table border="0" width="881" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
				...
				<tr>			 
					<td width="246" align="left"><img src="resources/images/logo.jpg"></td>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=882 border=0 class="border1 fntAr f11">
			<TBODY>
				<TR>
											...
											<table border="0" cellpadding="2" cellspacing="1" class="border1 fntAr f11" width="100%">
												<tbody>
													...
													<tr class="bgcolor">
														...
														<td class="bgcolor"><input type=password name="sPassword" size='19' class="ctrl" maxlength="15">
														</td>
													</tr>
													<tr class="bgcolor">
														<td colspan="2">
					...
					<center>
					<u><b><A HREF="javascript:onClick=popUp1('ForgetPassword.jsp')"  class="style180">Click here</a></b></u>
					
					<font size="2"> <B>if you forgot your password.</B></font></center>					
					</FORM>
					<table>
						<tr>
						...
						<tr>
							<td class="style180">
								<ol>											
									...
									<li class="style180"><A HREF="javascript:onClick=popUp1('resources/pdf/WCare_User_Manual_Ver15.pdf')" class="style180">User Manual</a></li>										
									<li class="style180"><A HREF="javascript:onClick=popUp1('Navigational.jsp')" class="style180">Portal Navigation Steps</a></li>
									<li class="style180"><A HREF="javascript:onClick=popUp1('Portal.jsp')" class="style180">Portal Features</a></li>		
								</ol>
							</td>
						</tr>
					</table>
							...
							<TR rowspan=4>
								...
								<table width="481" border="0">
									<tr>
										...
										quality of the service to our esteemed customers, Wind World has come up with &ldquo;<span class="style12">W-CARE</span>&rdquo;<span
									...
									<tr>
										<td class="style19">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wind World (India) Ltd</td>
									</tr>
									<tr>
										<td class="style19">&nbsp;</td>
									</tr>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=882 border=0>
			<TBODY>
				...
				<TR>
					...
					Site best viewed in Mozilla version 30 and above. &copy;2013 Wind World (India) Ltd. </span></TD>
				</TR>
			</TBODY>
		</TABLE>
</BODY>
