...
<html>
                ...
                if (type == "D") {
                    if (url != "") {
                        if (window.frames['ifrm']) {
                            ...
                            window.frames['ifrm'].location = "../dgrByDay.do" + "?id=" + list2.options[list2.selectedIndex].value + "&rd=" + rd;
                    ...
                    if (url != "") {
                        if (window.frames['ifrm']) {
                            var list2 = document.forms[0].CustIdtxt;
                            console.log(url + "?id=" + list2.options[list2.selectedIndex].value + "&rd=" + rd + "&type=" + type);
    ...
    <body valign="top" align="center" onLoad="loadintoIframe('ifrm', '../BlankN.jsp')" style="overflow: hidden">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr width="100%">
                    <td width="100%" align="center">
                        <form action="<%=request.getContextPath()%>/DGRREPORT.do"
                              method="post" name="DGRREPORT" body leftmargin="0" topmargin="0">
                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                   width="500">
                                <tbody>
                                    <tr>
                                    ...
                                    %>
                                    <tr>
                                        <td class="newheadl"><img
                                                src="<%=request.getContextPath()%>/resources/images/pixel.gif"
                                                border="0"></td>
                                        <td colspan="3"><img
                                                src="<%=request.getContextPath()%>/<%=request.getContextPath()%>/resources/images/pixel.gif"
                                                            ...
                                                            <table border="0" cellpadding="2" cellspacing="1"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="bgcolor">
                                                                        ...
                                                                        <td class="bgcolor"><select size="1"
                                                                                                    id="CustIdtxt" name="CustIdtxt" class="ctrl">
                                                                ...
                                                                <tr class="bgcolor">
                                                                    ...
                                                                    <td class="bgcolor"><input type="text"
                                                                                               name="Datetxt" id="Datetxt" value="<%=rdate%>"
                                                                                               size="20" class="ctrl" maxlength="10"
                                                                                               onfocus="dc.focus()" /> <a href="javascript:void(0)"
                                                                                               id="dc"
                                                                                               onClick="if (self.gfPop)
                                                                                                           gfPop.fPopCalendar(document.DGRREPORT.Datetxt);
                                                                                                       return false;"><img class="PopcalTrigger" align="absmiddle" src="<%=request.getContextPath()%>/resources/images/calbtn.gif" border="0" alt=""></a></td>
                                                                </tr>
                                                                <% } else if (Type.equals("M") || Type.equals("DM")) {%>
                                                                <tr class="bgcolor">
                                                                    <td id="t_street_address">&nbsp;Select&nbsp;Month:</td>
                                                                    <td class="bgcolor"><select size="1" id="Monthtxt"
                                                                                                name="Monthtxt" class="ctrl">
                                                                        ...
                                                                        </select> Select Year: <select size="1" id="Yeartxt"
                                                                                                       name="Yeartxt" class="ctrl">
                                                                            <option value="0">--Make a Selection--</option>
                                                                ...
                                                                <tr class="bgcolor">
                                                                    ...
                                                                    <td class="bgcolor"><select size="1"
                                                                                                id="FiscalYeartxt" name="FiscalYeartxt" class="ctrl">
                                                                            <option value="0">--Make a Selection--</option>
                                                                ...
                                                                <% }%>
                                                                <tr class="bgcolor">
                                                                    <td colspan="2"><html:errors /> <%String str = (String) session.getAttribute("msg");%>
                                                                    <%if (str != null) {%> <%=str%> <%}%> <%session.setAttribute("msg", "");%>
                                                                <input type="hidden" name="Type" id="Type"
                                                                       value=<%=Type%>> <input type="hidden"
                                                                       name="todaydate" id="todaydate" value=<%=rdate%>>
                                                                </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" align="right" bgcolor="#006633">
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="btn" width="100"><input type="button"
                                                                                           name="Searchcmd" class="btnform" value="Generate"
                                                                                           onclick="checkWholeForm();" /></td>
                                                        <td width="1"><img
                                                                src="<%=request.getContextPath()%>/resources/images/pixel.gif"
                                                                border="0" height="18" width="1"></td>
                                                        <td class="btn" width="100"><input name="Reset"
                                                                                           value="Cancel" class="btnform" type="reset"></td>
                                                        <td width="1"><img
                                                                src="<%=request.getContextPath()%>/resources/images/pixel.gif"
                                                                border="0" height="18" width="1"></td>
                                                    </tr>
        ...
        <DIV id=progressbar style="DISPLAY: none" align="center">
            <IMG style="VERTICAL-ALIGN: bottom" src="<%=request.getContextPath()%>/resources/images/progressbar.gif"><Font size=4> Please wait...downloading data </Font>
        </DIV>
