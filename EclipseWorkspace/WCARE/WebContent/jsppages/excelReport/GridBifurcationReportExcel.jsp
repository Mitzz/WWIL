...
<%
	...
	String isWindspeedRequired=request.getAttribute("IsWindspeedRequired").toString();
...
<BODY>
	...
	<TABLE cellSpacing="1" cellPadding="1" width="100%" border="1">
		<TR>
			...
			<td vAlign="middle" align="center" rowspan="2"><b>Customer Scope Shutdown</b></td>
			<td vAlign="middle" align="center" rowspan="2"><b>Grid Trip Count</b></td>
			<% if(isWindspeedRequired.equals("true"))
				{%>
				<td vAlign="middle" align="center" rowspan="2"><b>Avg Windspeed</b></td>
				<td vAlign="middle" align="center" rowspan="2"><b>Max Windspeed</b></td>
				<td vAlign="middle" align="center" rowspan="2"><b>Min Windspeed</b></td>
			<%}	%>		
		...
		<tr>
			...
			<% if(isWindspeedRequired.equals("true"))
				{%>
				<td class="data"><bean:write name="DataId" property="avgWindspeed"/></td>
				<td class="data"><bean:write name="DataId" property="maxWindspeed"/></td>
				<td class="data"><bean:write name="DataId" property="minWindspeed"/></td>
			<%}	%>	
