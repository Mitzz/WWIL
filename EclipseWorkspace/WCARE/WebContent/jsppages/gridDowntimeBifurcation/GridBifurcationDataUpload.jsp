    ...
    <head>
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
        		$("#gridBifurcationDataUpload").submit(function(){
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
                <tr width="100%">
                    <td width="100%" align="center">
                        <form action="<%=request.getContextPath()%>/gridBifurcationDataUpload.do" method="post" enctype="multipart/form-data" name = "gridBifurcationDataUpload" id = "gridBifurcationDataUpload">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="500">
                                <tbody>
                                	<tr>
                                        <td class="newhead1"></td>
                                        <th class="headtext">Upload WEC Data With Additional Grid Downtime</th>
                                        <td>
                                                                ...
                                                                <tbody>
                                                                	<tr class="bgcolor">
                                                                		<td colspan="2" style="text-align: center; font-weight: bolder;color: blue;" >
                                                                			Please Refer the new excel format w.e.f. <u>27-AUG-2014</u> before uploading. 
                                                                		</td>
                                                                	</tr>
                                                                	<tr class="bgcolor"> 
                                                                    ...
                                                                    <tr class="bgcolor">
																		...
																		<logic:messagesPresent property="gridBifurcationException" message="true">
																		<td style="color:red;text-align: center;" colspan="2">
                                                                    		<html:messages id="message" property="gridBifurcationException" message="true">
     																			<bean:write name="message"/>
   																			</html:messages>
																		</td>
																		</logic:messagesPresent>
