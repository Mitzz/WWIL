    ...
    <head>
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
        		$("#InitialReadingUpload").submit(function(){
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
                <tr width="100%">
                    <td width="100%" align="center">
                        <form action="<%=request.getContextPath()%>/InitialReadingUpload.do" method="post" enctype="multipart/form-data" name = "InitialReadingUpload" id = "InitialReadingUpload">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="500">
                                <tbody>
                                	<tr>
                                        <td class="newhead1"></td>
                                        <th class="headtext">Upload Initial Reading Data For WEC</th>
                                        <td>
