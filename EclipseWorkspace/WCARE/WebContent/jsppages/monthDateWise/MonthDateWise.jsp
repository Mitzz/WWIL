...
// 	        int startingFiscalYear=2012;
        ...
        <script type="text/javascript">
            ...
            function loadExternal(url) {
                ...
                url = "monthDateWiseCumulative.do";
                if (type == "M" || type == "DM") {
                ...
                if (type == "D") {
                    ...
                    if (url != "") {
                        if (window.frames['ifrm']) {
                            var list2 = document.forms[0].CustIdtxt;
							console.log(url + "?customerId=" + list2.options[list2.selectedIndex].value + "&month=" + list3.options[list3.selectedIndex].value + "&year=" + list4.options[list4.selectedIndex].value);	
                            window.frames['ifrm'].location = url + "?customerId=" + list2.options[list2.selectedIndex].value + "&month=" + list3.options[list3.selectedIndex].value + "&year=" + list4.options[list4.selectedIndex].value;
                            // window.open(url+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type);
    	...
    	if(type=="DG"){
    		if(url !=""){
     	 		if (window.frames['ifrm'] ) {
    				...
    				/* var list3=document.forms[0].Monthtxt;
    				var list4=document.forms[0].Yeartxt; */
     				/* var monthValue = document.getElementById("Monthtxt").value;
     				var yearValue = document.getElementById("Yeartxt").value; */
    				window.frames['ifrm'].location = "Change/DGRView_DGRWithCumulative.jsp"+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type+"&month="+monthValue+"&year="+yearValue;
    				// window.open(url+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type);
    		...
    		if(url !=""){
     	 		if (window.frames['ifrm'] ) {
    				...
    				var list4=document.forms[0].Yeartxt; */
     				var monthValue = document.getElementById("Monthtxt").value;
     				var yearValue = document.getElementById("Yeartxt").value;
    				window.frames['ifrm'].location = "Change/DGRViewForByMonth_DateWise.jsp"+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type+"&month="+monthValue+"&year="+yearValue;
    				// window.open(url+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type);
    		...
    		if(url !=""){
     	 		if (window.frames['ifrm'] ) {
    				...
    				var list4=document.forms[0].Yeartxt; */
     				var monthValue = document.getElementById("Monthtxt").value;
     				var yearValue = document.getElementById("Yeartxt").value;
    				window.frames['ifrm'].location = "Change/DGRViewByMonth_MachineWise.jsp"+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type+"&month="+monthValue+"&year="+yearValue;
    				// window.open(url+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type);
     	   			return false;
    			} 
     	 		else if ( document.layers ) {
    		...
    		if(url !=""){
     	 		if (window.frames['ifrm'] ) {
    				...
    				/* var list3=document.forms[0].Monthtxt;
    				var list4=document.forms[0].Yeartxt; */
     				var yearValue = document.getElementById("FiscalYeartxt").value;
    				console.log("yyyyyyyyyy" + yearValue);
    				var s = yearValue.split("/");
    				console.log("sdsdsd" + s[2]);
     				window.frames['ifrm'].location = "Change/DGRViewByYear_WECWise.jsp"+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type+"&year="+s[2];
    				// window.open(url+"?id="+list2.options[list2.selectedIndex].value+"&rd="+rd+"&type="+type);
     	   			return false;
    			} 
     	 		else if ( document.layers ) {
	...
	<% }else if(Type.equals("M") || Type.equals("DM")){	%>		
		...
		<tr class="bgcolor"> 
			...
			<td class="bgcolor">
		        	...
		        	<select size="1" id="FiscalYeartxt" name="FiscalYeartxt" class="ctrl">
		            <option value="0">--Make a Selection--</option>
		             <option value="01/05/2013">2013-2014</option>
