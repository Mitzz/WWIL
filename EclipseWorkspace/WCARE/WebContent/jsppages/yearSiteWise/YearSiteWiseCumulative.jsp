	            ...
	            <div id='menu' align='left'>
		            ...
		            <Table  cellSpacing=0 cellPadding=0 width=100% bgColor=#555555 border=1>
						...
						<tr class=${ class }>
	  					...
	  					<tr class=TableSummaryRow>
	  						<%-- <td class=TableCell1>${ stateDetail.state.name }</td> --%>
	  						<td class=TableCell1><a href="<c:url value="/yearSiteWiseSiteDetail.do"/>?stateId=<c:out value="${ stateDetail.state.id }" />&customerId=<c:out value="${ stateDetail.customer.id }"/>&fiscalYear=<c:out value="${ fiscalYear }" />" target="_blank"> ${ stateDetail.state.name }</a></td>
