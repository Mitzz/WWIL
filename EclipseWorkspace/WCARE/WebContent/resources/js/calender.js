function show_calendar(str_target, str_datetime) { 
 ...
 var str_buffer = new String ( 
  ...
  "<img src=\"\.\.\/images\/leftarrow.jpg\" width=\"12\" height=\"12\" border=\"0\""+ 
  ...
  "<img src=\"\.\.\/images\/rightarrow.jpg\" width=\"12\" height=\"12\" border=\"0\""+ 
  " alt=\"next month\"></a></td>\n</tr>\n" 
 ); 
 ...
 str_buffer += 
  ...
  "</body>\n" + 
  "</html>\n"; 
 var vWinCal = window.open("", "Calendar","width=200,height=230,status=no,left=500,top=100,menubar=0,toolbar=0"); 
 vWinCal.opener = self; 
...
{ 
 return (new  
  ...
  //To enable Search button on the SearchContent Page
function enableSearchButton(searchtype)
{
    document.getElementById("SidSearchButton").disabled=false;
    document.forms[1].selection.value=searchtype;
    document.forms[1].timeStampTo.value="";
    document.forms[1].timeStampFrom.value="";
    return true;
