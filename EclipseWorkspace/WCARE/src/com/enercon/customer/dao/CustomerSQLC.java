...
*/	
	...
	public static final String CHECK_MESSAGE_SEND_BY_LOG_ID=
    	" SELECT cm.S_CUSTOMER_NAME,MD.S_MESSAGE_DESCRIPTION FROM TBL_MESSAGE_DETAIL MD,TBL_MESSAGE_POST MP," +
    	"TBL_CUSTOMER_MASTER CM WHERE CM.S_CUSTOMER_ID=MP.S_CUSTOMER_ID AND " +
    	"CM.S_LOGIN_MASTER_ID IN ( SELECT S_LOGIN_MASTER_ID FROM TBL_LOGIN_MASTER " +
    	"WHERE S_USER_ID=?) " +
    	" AND  "+
    	" MP.S_MESSAGE_DETAIL_ID=MD.S_MESSAGE_DETAIL_ID "+
        " AND  SYSDATE BETWEEN MD.D_FROM_DATE AND MD.D_TO_DATE+1 ";
