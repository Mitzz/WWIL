...
public class WECDao implements WcareConnector, AllQueries {
	private final static Logger logger = Logger.getLogger(WECDao.class);
	...
	public Map<String, Map<WecLocationData, String>> getWECData() throws SQLException {
