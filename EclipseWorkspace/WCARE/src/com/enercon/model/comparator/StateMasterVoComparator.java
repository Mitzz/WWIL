...
public class StateMasterVoComparator {
	...
	public final static Comparator<IStateMasterVo> BY_NAME = byName();
	...
	private static Comparator<IStateMasterVo> byName(){
		return new Comparator<IStateMasterVo>(){
			public int compare(IStateMasterVo o1, IStateMasterVo o2) {
	...
	public static int sortByName(IStateMasterVo o1, IStateMasterVo o2) {
