...
public interface IWecParameterVo {
	...
	long averageGeneration();
	void averageGeneration(long value);
	
	long averageOperatingHour();
	void averageOperatingHour(long value);
	...
	double mia();
	void mia(double value);
	
	String remark();
	void remark(String value);
	
	double averageGenerationPerWec();
	void averageGenerationPerWec(double value);
	
	double averageOperatingHourPerWec();
	void averageOperatingHourPerWec(double value);
