...
public class DgrWecAction extends Action{
	
	private static Logger logger = Logger.getLogger(DgrWecAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		String dateInOracleFormat = DateUtility.convertDateFormats(date, "dd/MM/yyyy", "dd-MMM-yyyy");
...
//		logger.debug("Date: " + date);
		...
		for(IEbMasterVo eb: ebs){
			...
			ebDgr = new EbDgr(dateInOracleFormat, customer, eb).populateDetails();
		...
		wecParameterdata.setFromDate(dateInOracleFormat);
		wecParameterdata.setToDate(dateInOracleFormat);
		...
		ebParameterdata.setFromDate(dateInOracleFormat);
		ebParameterdata.setToDate(dateInOracleFormat);
