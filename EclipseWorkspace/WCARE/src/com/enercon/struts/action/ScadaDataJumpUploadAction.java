...
public class ScadaDataJumpUploadAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String loginId = session.getAttribute("loginID").toString() + "_SJ";
		ActionMessages messages = new ActionMessages();
		ScadaDataJumpUploadForm initialReadingUpload = null;
		WcareDao dao = new WcareDao();
		
		try{
			initialReadingUpload = (ScadaDataJumpUploadForm) form;
			...
			dao.validateDataForScadaJumpData(excelData);
