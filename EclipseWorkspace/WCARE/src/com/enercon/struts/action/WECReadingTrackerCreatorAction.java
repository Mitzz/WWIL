...
public final class WECReadingTrackerCreatorAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping,	ActionForm form,HttpServletRequest request,	HttpServletResponse response) 
		...
		try{	
			...
			request.setAttribute("WECReadingTrackerData", new AdminDao().getWECReadingTrackerReport(dynaBean));
