...
public class GridBifurcationDataUploadForm extends ActionForm{

	private FormFile excelFile;
	private String excelSheetName;
	
	public GridBifurcationDataUploadForm() {
		super();
	...
	public String toString() {
		return "GridBifurcationDataUploadForm [excelFile=" + excelFile
